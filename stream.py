...
if page=='Model Bazlı Aylık Tahmin':
    ...
    if selected_model=='Ocak 2024':
       ...
       fig4 = px.bar(modelaylık.iloc[0,:], x=modelaylık.iloc[0,:].sort_values(ascending=False).values.columns, y=modelaylık.iloc[0,:].sort_values(ascending=False).values,labels={'y':'Tahmin'})
