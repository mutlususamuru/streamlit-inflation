...
fig3.add_trace(go.Scatter(x=yıllıktahmin["Minimum"].iloc[11:].index,y=yıllıktahmin["Minimum"].iloc[11:],mode='lines',name="SGD Regressor",line={'dash': 'dash'}))
fig3.add_trace(go.Scatter(x=yıllıktahmin["Maksimum"].iloc[11:].index,y=yıllıktahmin["Maksimum"].iloc[11:],mode='lines',name="Lasso Regression"),line={'dash': 'dash'})
fig3.add_trace(go.Scatter(x=yıllıktahmin["Lasso Regression"].iloc[11:].index,y=yıllıktahmin["Lasso Regression"].iloc[11:],mode='lines',name="Lars Regression"),line={'dash': 'dash'})
fig3.add_trace(go.Scatter(x=yıllıktahmin["Lars Regression"].iloc[11:].index,y=yıllıktahmin["Lars Regression"].iloc[11:],mode='lines',name="Gaussian Regression"),line={'dash': 'dash'})
