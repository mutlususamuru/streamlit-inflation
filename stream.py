...
fig1.add_trace(go.Scatter(x=yıllıktahmin.index[23:],y=yıllıktahmin["Ortalama"].iloc[23:-2],mode='lines',line_color='red',line=dict(dash='dash')))
fig1.add_trace(go.Scatter(x=yıllıktahmin.index[24:],y=yıllıktahmin["Ortalama"].iloc[24:-2],mode='markers',name="Tahmin",marker=dict(size=10, color='orange')))
...
fig.add_trace(go.Bar(x=next_12_months.index, y=next_12_months.values, name="Tahmin"))
