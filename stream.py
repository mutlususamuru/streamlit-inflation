...
fig2.update_traces(texttemplate='%{text:.2f}', textposition='outside', textangle=0,textfont=dict(size=20))
fig2.update_layout(font=dict(family="Arial Black", size=14, color="black"))
fig2.update_xaxes(
    tickformat="%Y-%m"  # Adjust the format as needed
)
