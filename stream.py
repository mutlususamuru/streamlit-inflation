...
fig1 = go.Figure()
fig1.add_trace(go.Scatter(x=yıllıktahmin.index[:14],y=yıllıktahmin["Ortalama"].iloc[:13],mode='lines',name="Enflasyon"))
fig1.add_trace(go.Scatter(x=yıllıktahmin.index[13:],y=yıllıktahmin["Ortalama"].iloc[12:27],mode='lines',name="Tahmin"))
fig1.add_trace(go.Scatter(x=yıllıktahmin.index[10:14],y=[61.94,60.84,62.18,64.70],mode='markers',name="Geçmiş Tahminler"))
