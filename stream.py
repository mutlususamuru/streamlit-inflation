...
fig1.add_trace(go.Scatter(x=yıllıktahmin.index[23:],y=yıllıktahmin["Ortalama"].iloc[23:-2],mode='lines',line_color='red',name="Tahmin",line=dict(dash='dash')))
fig1.add_trace(go.Scatter(x=yıllıktahmin.index[23:],y=yıllıktahmin["Ortalama"].iloc[23:-2],mode='markers',marker=dict(size=20, color='orange')))
